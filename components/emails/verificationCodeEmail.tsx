...
export function ResetPasswordEmail({ firstName, code }: { firstName: string; code: string }) {
  return (
    <div
      style={{
        fontFamily: "Arial, sans-serif",
    ...
    >
      ...
      >
        ...
        <div style={{ padding: "30px" }}>
          ...
          <p style={{ fontSize: "16px", color: "#555", lineHeight: "1.6" }}>
            We received a request to reset your <b>Alnnovate</b> account password.  
            To continue, please use the 6-digit OTP below:
          </p>
